...
public class Bill {
	...
	public Bill(Date date, Date time, Customer customer, String comment, Status status) {
		super();
		this.date = date;
		this.time = time;
	...
	public Bill(int id, Date date, Date time, Customer customer, String comment, Status status) {
		super();
		this.id = id;
		this.time = time;
		this.date = date;
